...
class pegawai{
    ...
    function GetData_All (){
     ...
     function GetData_All_l (){
        ...
        // perintah Get data
        $this->query=mysqli_query($this->con,"select * from pbo_pegawai where jns_kel='L'");
        while($this->data=mysqli_fetch_array($this->query)){
            $this->result[]=$this->data;
        }
        return $this->result;
     ...
     function GetData_All_M (){
        ...
        // perintah Get data
        $this->query=mysqli_query($this->con,"select * from pbo_pegawai where status='M'");
        while($this->data=mysqli_fetch_array($this->query)){
            $this->result[]=$this->data;
        }
        return $this->result;
     ...
     function GetData_All_B (){
        ...
        // perintah Get data
        $this->query=mysqli_query($this->con,"select * from pbo_pegawai where status='B'");
        while($this->data=mysqli_fetch_array($this->query)){
            $this->result[]=$this->data;
        }
        return $this->result;
       ...
       function GetData_All_U5 (){
        ...
        // perintah Get data
        $this->query=mysqli_query($this->con,"SELECT * ,TIMESTAMPDIFF(YEAR, tgl_lahir, CURDATE()) AS umur FROM pbo_pegawai");
        while($this->data=mysqli_fetch_array($this->query)){
     ...
     function GetData_All_U6 (){
        ...
        return $this->result;
         ...
         function GetData_All_U7 (){
            ...
            // perintah Get data
            $this->query=mysqli_query($this->con,"SELECT * ,TIMESTAMPDIFF(YEAR, mulai_kerja, CURDATE()) AS umur FROM pbo_pegawai");
            while($this->data=mysqli_fetch_array($this->query)){
